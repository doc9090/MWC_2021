...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mSensorDetect = mSensorManager.getDefaultSensor(Sensor.TYPE_STEP_DETECTOR);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    if(mSensorDetect!=null){
                        mSensorManager.registerListener(listener,mSensorDetect,SensorManager.SENSOR_DELAY_NORMAL);
...
class StepCounterListener implements SensorEventListener {
    ...
    //TODO 10
    public StepCounterListener(TextView tv,ProgressBar a){

        stepsCountTextView=tv;
        stepsCountProgressBar=a;
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            ...
            case Sensor.TYPE_STEP_DETECTOR:
                ...
                mAndroidStepCount=event.values[0];
                countSteps(mAndroidStepCount);

                Log.d("STEP_DECT", "dec: " + String.valueOf(counter));
    ...
    private void countSteps(float steps) {
